...
export default function BirthdayPage() {
  return (
    <BirthYearGate>
      <main className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#1a1625' }}>
        {/* Animated Background Gradient Orbs */}
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
          {/* Large gradient orb - top left */}
          <div 
            className="absolute -top-1/4 -left-1/4 w-[600px] h-[600px] rounded-full opacity-40 blur-3xl animate-pulse"
            style={{
          ...
          <div 
            className="absolute -top-1/4 -right-1/4 w-[500px] h-[500px] rounded-full opacity-35 blur-3xl animate-pulse"
            style={{
          ...
          <div 
            className="absolute -bottom-1/4 -left-1/4 w-[550px] h-[550px] rounded-full opacity-35 blur-3xl animate-pulse"
            style={{
          ...
          <div 
            className="absolute -bottom-1/4 -right-1/4 w-[450px] h-[450px] rounded-full opacity-40 blur-3xl animate-pulse"
            style={{
